    ...
    public void run() {
        try {
            ...
            while ((line = bufr.readLine()) != null) {
                ...
                DatagramPacket dp = new DatagramPacket(buf, buf.length,InetAddress.getByName("192.168.123.220"),10086);
                ds.send(dp);
                if("886".equals(line)) {
                    break;
                }
    ...
    public void run(){
        try{
            while(true){
                ...
                System.out.println("received message from "+ ip+", message: "+data);
            }
        }
        catch(Exception e){
